...
from tgmb-chizu import parent_id, DOWNLOAD_DIR, IS_TEAM_DRIVE, INDEX_URL, USE_TELEGRAPH, \
...
from tgmb-chizu.helper.ext_utils.bot_utils import *
from tgmb-chizu.helper.ext_utils.fs_utils import get_mime_type, get_path_size
        ...
        try:
            ...
            if meta.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                if SHORTENER is not None and SHORTENER_API is not None:
                    surl = requests.get(
                        'https://{}/api?api={}&url={}&format=text'.format(SHORTENER, SHORTENER_API, durl)).text
                ...
                if INDEX_URL is not None:
                    ...
                    if SHORTENER is not None and SHORTENER_API is not None:
                        siurl = requests.get(
                            'https://{}/api?api={}&url={}&format=text'.format(SHORTENER, SHORTENER_API, url)).text
